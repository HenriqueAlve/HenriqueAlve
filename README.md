...
public class Developer {
    ...
    private String[] backend  = {"Java", "Spring Boot", "REST APIs", "PostgreSQL"};
    private String[] mobile   = {"Flutter", "Dart", "Firebase", "GetX"};
    private String[] frontend = {"React", "TypeScript", "Tailwind CSS"};

    public String missao() {
        return "Transformar ideias em produtos que fazem diferença.";
    }
}
```
